...
//		System.out.println("12: " + willBuyDrink(true, 11.00));
		...
		//13
		System.out.println("Answer with true or false: It is currently dark.");
		Scanner answer = new Scanner(System.in);
		boolean darkness = answer.nextBoolean();
		System.out.println("How many people are in the room?");
		int population = answer.nextInt();
		System.out.println(lightsGoOnOrOff(darkness, population));
		answer.close();
	}
